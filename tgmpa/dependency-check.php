...
add_action( 'tgmpa_register', 'pitchfork_people_register_required_plugins' );

/**
 * Register the required plugins for this plugin.
 */
function pitchfork_people_register_required_plugins() {
	/*
	 ...
	 */
	$config = array(
		'id'           => 'pitchfork_people',      // Unique ID for hashing notices for multiple instances of TGMPA.
