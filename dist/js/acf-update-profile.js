...
/*!*******************************************!*\
  !*** ./src/scripts/acf-update-profile.js ***!
  \*******************************************/
/**
...
jQuery(document).ready(function ($) {
  ...
  button = '<button id="update-fields" type="button" class="button button-primary button-large">' + 'Update fields from feed</button>';
  ...
  */
  ...
  function update_fields_from_feed() {
    ...
    if (toggleDisable) {
      dataFields = {
        'field_63d842cf70dee': profileData.display_name.raw,
        // pfpeople_name
        'field_63d842cf70e00': 'https://search.asu.edu/' + profileData.eid.raw,
        // pfpeople_url
        'field_63d842cf70e07': profileData.primary_title.raw[0],
        // pfpeople_title
        'field_63d842cf70e0b': profileData.primary_department.raw,
        // pfpeople_department
        'field_63d842cf70e0e': profileData.bio.raw,
        // pfpeople_description
  ...
  function toggle_data_fields_state(enable) {
    ...
    dataFields = ['field_63d842cf70dee',
    // pfpeople_name
    'field_63d842cf70e00',
    // pfpeople_url
    'field_63d842cf70e07',
...
/******/ })()
;
//# sourceMappingURL=acf-update-profile.js.map